...
# Description: This script can generate all the bash files (.sh) to run Gaussian calculations in SLURM for lochness automaticly. 
# Run as: python g16_lochness_submit.py file.com number_of_days number_of_CPUs
...
def write_bash_file(bash_filename, g16_filename, filename):
    ...
    bash_file.write("module load gaussian/g16_C.01\n")
